...
puts get_rid_of_surrounding_whitespaces("      Aguathe est la plus belle ?     ")
...
puts belongs_to?("Agathe est la plus belle", "Agathe")
...
puts replace("Agathe est la plus belle", "Agathe", "Morgane")
...
puts ascending_order([12, 21, 3, 3, 44, 23])
